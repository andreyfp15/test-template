      ...
      <div v-show="modalActive" class="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-40">
        ...
        <Transition name="modal-inner">
          <div v-show="modalActive"
            class="absolute fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center border-l-6 border-[#F87171] bg-[#F2E1E5] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9 rounded-lg w-[500px] h-[500px] z-50">
