...
<template>
  <DefaultLayout>
          ...
          <div class="flex flex-col gap-5.5 p-6.5">
            ...
            <div>
              ...
              <input type="text" placeholder="Active Input"
                class="w-full rounded-lg border-[1.5px] text-black border-primary bg-transparent py-2 px-3 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:bg-form-input" />
            </div>
            ...
            <div>
              ...
              <input type="text" placeholder="Disabled label" disabled
                class="w-full rounded-lg border-[1.5px] text-black border-stroke bg-transparent py-2 px-3 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary dark:disabled:bg-black" />
            </div>
          </div>
        </DefaultCard>
        <!-- Input Fields End -->
          ...
          <div class="flex flex-col gap-5.5 p-6.5">
            <div>
              ...
              <textarea rows="6" placeholder="Default textarea"
                class="w-full rounded-lg border-[1.5px] text-black border-stroke bg-transparent py-2 px-3 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"></textarea>
            </div>
            ...
            <div>
              ...
              <textarea rows="6" placeholder="Active textarea"
                class="w-full rounded-lg border-[1.5px] text-black border-primary bg-transparent py-2 px-3 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:bg-form-input"></textarea>
            </div>
            ...
            <div>
              ...
              <textarea rows="6" disabled placeholder="Disabled textarea"
                class="w-full rounded-lg border-[1.5px] text-black border-stroke bg-transparent py-2 px-3 font-normal outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:text-white dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary dark:disabled:bg-black"></textarea>
            </div>
          </div>
        </DefaultCard>
        <!-- Textarea Fields End -->
    ...
    <div class="grid grid-cols-1 gap-9 sm:grid-cols-1 pt-5">
      <div class="flex flex-col gap-9">

        <DefaultCard cardTitle="Teste formulários">
          <form action="#">
            <div class="p-6.5">
              ...
              <InputGroup label="Email" type="email" placeholder="Enter your email address" customClasses="mb-4.5 xl:w-1/4"
                required />

              <InputGroup label="Subject" type="text" placeholder="Enter your subject" customClasses="mb-4.5 xl:w-1/2" />

              <SelectGroupTwo />

              <div class="mb-6">
                <label class="mb-1 block text-black dark:text-white"> Message </label>
